...
public function filter4 ($table,$awal,$akhir)
    ...
    {
        return $this->db->table($tabel)->join($tabel2,$on) ->get()->getResult();
	...
	public function join1($table, $table1,$on)
    {
         return $this->db->table($table)->join($table1, $on, 'left')->get()->getResult();
    }
