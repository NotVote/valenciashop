    ...
    <div class="col-md-6 mb-3">
        <div class="card">
            ...
            <label class="col-sm-4 col-form-label col-form-label-sm"><b>Tanggal Transaksi</b></label>
                        ...
                        <label class="col-sm-4 col-form-label"><b>Harga</b></label>
                        <div class="col-sm-8 mb-2">
                            <input type="number" class="form-control form-control-sm" id="harga_barang" onchange="total()"
                             value="<?php echo $row['harga_barang'];?>" name="harga_barang"  placeholder="0" required>
                        </div>
                        <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Quantity</label>
                        <div class="col-sm-8 mb-2">
...
function format_ribuan ($nilai){
  ...
  <div class="col-md-6 mb-3">
      <div class="card" id="print">
          <div class="card-header bg-yellow border-0 pb-0 pt-4">
      ...
      while($dat = mysqli_fetch_array($toko)){
        ...
        echo "<img src='assets/images/logoo.PNG' alt='logo' style='width: 180px; height: 100px;' class='float-right'>";
    ...
    echo "</div>";
          ...
          <hr class="mt-0">
              ...
              <div class="col-5 pr-0">
                  <a href="?id=<?php echo $d['id_cart']; ?>" onclick="javascript:return confirm('Hapus Data Barang ?');" style="text-decoration:none;">
                      ...
                      <span class="text-white"><?php echo $d['nama_barang']; ?></span>
                  </a>
              </div>
              <div class="col-1 px-0 text-center">
      ...
      <div class="text-right mt-3">
          <form method="POST">
            <button class="" onclick="printContent('print')"><i class="fa fa-print mr-1"></i> Print</button>
            <button class=" "name="selesai" type="submit"><i class="fa fa-print"></i> Selesai</button>
          </form>
      </div>
